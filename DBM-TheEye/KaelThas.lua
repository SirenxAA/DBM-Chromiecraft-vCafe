...
--		self:Schedule(40, MCFailsafe, self)
	elseif msg == L.YellPhase5 or msg:find(L.YellPhase5) then
		...
		timerFlameStrikeCD:Start(36+10+54) --2024.07.06 adjustment to 10,000ms
		timerGravityCD:Start(60-24+5)
		timerPhoenixCD:Start(137-101+71-21) -- Lys: transition event is 36s, 2024.07.06 adjusted to 50s after RP (36s)
	end
end
